...
public class SalaryFormController {
    ...
    private void generateNextSalaryId() {
        try {
            String id = salaryBO.generateNextSalaryId();
            txtSalId.setText(id);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        if (isSalaryValidated) {
            try {
                boolean isSaved = salaryBO.saveSalary(new SalaryDto(salId, empId, amount, date));
                if (isSaved) {
    ...
    void btnUpdateOnAction(ActionEvent event) {
        ...
        if (isSalaryValidated) {
            try {
                boolean isUpdated = salaryBO.updateSalary(new SalaryDto(salId, empId, amount, date));
                if(isUpdated) {
    ...
    void btnDeleteOnAction(ActionEvent event) {
        ...
        try {
            boolean isDeleted = salaryBO.deleteSalary(salId);
    ...
    void txtSearchOnAction(ActionEvent event) {
        ...
        try {
            SalaryDto dto = salaryBO.searchSalary(salId);
