...
public class MaintenanceFormController {
    ...
    MaintenanceBO maintenanceBO = (MaintenanceBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.MAINTENANCE);
    ...
    private void loadAllNests() {
        ...
        try {
            List<NestDto> list = nestBO.getAllNests();
    ...
    private void generateNextTtId() {
        try {
            String id = maintenanceBO.generateNextTtId();
            txtTtId.setText(id);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        if (isTTValidated) {
            try {
                boolean isSaved = maintenanceBO.saveTt(new MaintenanceDto(ttId, empId, nestId, date));
                if (isSaved) {
    ...
    void btnUpdateOnAction(ActionEvent event) {
        ...
        try {
            boolean isUpdated = maintenanceBO.updateTt(new MaintenanceDto(ttId, empId, nestId, date));
            if(isUpdated) {
    ...
    void btnDeleteOnAction(ActionEvent event) {
        ...
        try {
            boolean isDeleted = maintenanceBO.deleteTt(ttId);
    ...
    void txtSearchOnAction(ActionEvent event) {
        ...
        try {
            MaintenanceDto dto = maintenanceBO.searchTt(ttId);
